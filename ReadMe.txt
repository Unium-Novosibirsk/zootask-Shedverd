На языкае С# реализовать интерфейс "Животное" со следующими полями:
1.Рост животного
2.Вес животного
...
Классы животных необходимо создать внутри папки Animals, а классы птиц необходимо создать внутри папки Birds.
...
В качестве бонусных заданий можно реализовать свой класс-коллекию, который будет отвечать за хранение животных а так же за реализацию алгоритмов встаки, удаления и проходов, а так же реализовать отдельный класс Menu, который будет отображать меню в консоле и осуществлять работу с пользователем.